...
## Quyết định
Đóng, không làm. Chủ dự án xác nhận package cố tình nhẹ, không phụ thuộc
SDK push cụ thể nào — `ReminderService` giữ nguyên phạm vi chỉ local
notification. Thêm seam trung lập cho remote push là mở rộng phạm vi chưa
ai cần tới (YAGNI).
