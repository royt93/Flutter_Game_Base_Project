...
## Acceptance criteria
[ ] Event sai tên/type/PII bị reject hoặc redact theo policy.\n- [ ] Schema version migration và unknown field policy rõ.\n- [ ] Provider failure không làm crash gameplay; report violation có context.
