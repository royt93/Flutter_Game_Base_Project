...
## Acceptance criteria
- [ ] change() với locale không được hỗ trợ không để app rơi vào trạng thái locale không dịch được.
- [ ] Test: gọi change() với locale ngoài danh sách supported, và với locale có country code khác nhưng cùng language code đã supported (đảm bảo không bị từ chối nhầm).
