...
## Acceptance criteria
[ ] Kill switch asset fallback an toàn và remote invalid không mở feature.\n- [ ] State reactive, cached last-known-good và audit reason/version.\n- [ ] Widget/service đang chạy nhận disable mà không crash hoặc grant sai.
