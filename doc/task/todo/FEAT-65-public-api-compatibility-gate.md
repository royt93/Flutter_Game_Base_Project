...
## Acceptance criteria
[ ] API snapshot được tạo và diff ổn định.\n- [ ] Breaking/additive/deprecation được phân loại đúng.\n- [ ] CI fail đúng khi version/changelog không phù hợp và pass khi migration hợp lệ.
