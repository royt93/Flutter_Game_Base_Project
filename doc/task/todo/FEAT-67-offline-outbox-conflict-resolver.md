...
## Acceptance criteria
[ ] Outbox bounded, idempotent, persisted và drain theo priority.\n- [ ] Conflict policy merge/reject/manual deterministic, không mất reward.\n- [ ] Crash giữa upload/ack không duplicate và không mất item.
