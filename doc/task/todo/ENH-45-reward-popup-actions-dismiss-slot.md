...
## Acceptance criteria
- [ ] RewardPopup hỗ trợ 1 cách khai báo hành động/nút đóng nhất quán với NeonDialog.panel hoặc SpotlightOverlay (chọn 1 hướng, không cần cả 2), không phá call site hiện có (actions/onDismiss optional, mặc định null).
- [ ] Test: truyền action/dismiss callback, xác nhận nút hiển thị đúng và tap gọi đúng callback.
