...
## Acceptance criteria
- [ ] throttled() không còn bị kẹt vô thời hạn khi wall clock bị lùi lại giữa 2 lần gọi.
- [ ] Test: mô phỏng đồng hồ lùi lại giữa 2 lần gọi (cần 1 seam/injectable clock để test được), xác nhận throttle window vẫn hoạt động đúng như bình thường (không bị kéo dài).
