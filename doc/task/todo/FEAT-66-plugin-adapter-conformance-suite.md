...
## Acceptance criteria
[ ] Mỗi adapter có conformance checklist và fake reference.\n- [ ] Timeout, retry, duplicate callback, dispose và privacy failure đều có test.\n- [ ] Consumer có thể chạy suite mà không import implementation vendor.
