...
## Acceptance criteria
[ ] CI tạo SBOM reproducible và fail policy severity cấu hình được.\n- [ ] Direct/transitive dependency và override được trace.\n- [ ] False positive có expiry/owner; dry-run artifact không chứa secret.
