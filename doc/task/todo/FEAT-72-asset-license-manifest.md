...
## Acceptance criteria
[ ] Mỗi asset runtime có owner/license/source hợp lệ.\n- [ ] CI fail asset mới thiếu manifest hoặc license cấm phân phối.\n- [ ] Publish dry-run chỉ chứa artifact được phép.
