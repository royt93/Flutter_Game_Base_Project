...
## Wave 21 — ✅ DONE 2026-06-23 (kỹ thuật + gameplay + meta)
...
| 4 | Rhythm Upgrade | BPM dynamic theo groove + judgment animation | ✅ done | `done/w21-4-rhythm-upgrade.md` |
| 5 | World Map Events | Treasure chest + mini-boss node + avatar đi bộ | ✅ done | `done/w21-5-world-map-events.md` |
| 6 | Offline Leaderboard | Bot score tất định top 10 cho Campaign + Daily | ✅ done | `done/w21-6-offline-leaderboard.md` |
