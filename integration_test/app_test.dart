...
void main() {
  ...
  // Mô phỏng đổi vòng đời app (background/resume) qua channel chuẩn 'flutter/lifecycle'.
  // Dùng channelBuffers.push (không deprecated) thay vì handleAppLifecycleStateChanged
  // (vốn @protected) để giữ analyze 0 issue.
  ...
  // và nút Back vật lý. Chạy: flutter test integration_test/app_test.dart -d <device>.
