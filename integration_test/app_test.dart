// Bộ e2e Wave 5 (điều hướng menu, nhanh). Các case lifecycle/back-stack chậm (real-time,
// vào GameScreen) tách sang integration_test/tc12_lifecycle_test.dart với @Tags(['slow']).
