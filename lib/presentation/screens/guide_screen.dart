                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _section(
                      ...
                      children: [
                        ...
                        _bullet(NeonTheme.magenta, Icons.blur_on_rounded, '',
                            'guide_mode_jelly'.tr),
                        _bullet(NeonTheme.orange, Icons.timer_rounded, '',
                            'guide_mode_time'.tr),
                        _bullet(NeonTheme.lime, Icons.south_rounded, '',
                            'guide_mode_drop'.tr),
                        _bullet(NeonTheme.cyan, Icons.ac_unit_rounded, '',
                            'guide_mode_obstacle'.tr),
                      ],
                    ),
                    _section(
                      color: NeonTheme.cyan,
                      icon: Icons.ac_unit_rounded,
                      title: 'guide_obstacle_title'.tr,
                    ...
                    _section(
                      ...
                      title: 'guide_w14_title'.tr,
                      body: 'guide_w14_body'.tr,
                    ),
                    _section(
                      color: NeonTheme.yellow,
