...
class CollectionItem {
  ...
  const CollectionItem(this.id, this.nameKey, this.threshold, this.colorIndex);
}

/// 12 sticker album — ngưỡng tích luỹ tăng dần (vật sưu tập, không thưởng riêng).
const List<CollectionItem> kCollectionItems = [
  CollectionItem('cyan_spark', 'coll_cyan_spark', 30, 0),
  CollectionItem('magenta_bloom', 'coll_magenta_bloom', 80, 1),
  CollectionItem('lime_leaf', 'coll_lime_leaf', 150, 2),
  CollectionItem('amber_sun', 'coll_amber_sun', 240, 3),
  CollectionItem('orange_ember', 'coll_orange_ember', 350, 4),
  CollectionItem('violet_dusk', 'coll_violet_dusk', 480, 5),
  CollectionItem('prism_shard', 'coll_prism_shard', 640, 0),
  CollectionItem('nebula_core', 'coll_nebula_core', 820, 1),
  CollectionItem('aurora_wing', 'coll_aurora_wing', 1030, 2),
  CollectionItem('quasar_eye', 'coll_quasar_eye', 1280, 3),
  CollectionItem('pulsar_heart', 'coll_pulsar_heart', 1560, 4),
  CollectionItem('singularity', 'coll_singularity', 1880, 5),
];
